...
public class SearchClientConfig
{
    ...
    /// </summary>
    public int MaxMatchesCount { get; set; } = 10;
    ...
    /// </summary>
    public int AnswerTokens { get; set; } = 2000;

    /// <summary>
    /// Text to return when the LLM cannot produce an answer.
    /// </summary>
    public string EmptyAnswer { get; set; } = "Could not find the information you are looking for, please rephrase your question.";
    ...
    /// </summary>
    public string FactTemplate { get; set; } = "==== [File:{{$source}};FileId:{{$fileId}};DocId:{{$documentId}};PartNum:{{$partitionNumber}};SecNum:{{$sectionNumber}};Rel:{{$relevance}}]:\n{{$content}}";
